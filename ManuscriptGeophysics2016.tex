...
This can be seen very nicely in the results. Figures~\ref{fig:emmod-HS} (b) and
...
error patterns from empymod in Figures~\ref{fig:onederror-amplitude} and
...
%
\plot*[btp]{gpr}{width=1\textwidth}{GPR example for (b) EMmod, (c) empymod with
  QUAD for relative and absolute tolerance of $10^{-12}$ and $10^{-20}$,
